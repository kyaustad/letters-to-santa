...
import { Check, Star, Gift, Truck, Clock } from "lucide-react";

export const PricingSection = () => {
  const features = [
    "Choose from 7 beautiful templates",
    ...
    "Satisfaction pretty much a guarantee",
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <Card className="relative border-2 border-primary shadow-xl">
            ...
            <CardHeader className="text-center pb-4">
              ...
              <p className="text-muted-foreground">
                {`Everything you need for the perfect letter from Santa this Christmas`}
              </p>
            </CardHeader>
          ...
          <Card className="bg-gradient-to-br from-primary/5 to-secondary/5">
            ...
            <CardContent className="space-y-6 flex flex-col items-center justify-between h-full w-full">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {`Letters are stamped and mailed directly to your recipient, showing the official North Pole postmark.`}
                  </p>
                </div>
              </div>
