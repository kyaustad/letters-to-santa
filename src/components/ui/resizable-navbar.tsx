    ...
    >
      {items.map((item, idx) => (
        ...
        >
          ...
          <span
            className={cn(
              "relative z-20 text-lg font-light",
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -10 }}
          className={cn(
            "absolute top-full left-0 right-0 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-b-lg bg-white px-4 py-6 shadow-lg border-b border-gray-200/50 dark:bg-neutral-950 dark:border-neutral-800/50",
            className,
          )}
        >
          {children}
